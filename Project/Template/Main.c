/******************************************************************************
 *
 *	Notes:	Main.h is included first because sometimes compiler include files
 *			can use special defined symbols (like _XTAL_FREQ for PIC), and it's
 *			nice to tuck them in the Main.h file.   Main.h also should contain
...
#include "Main.h"						// global settings
										// TODO:  Include processor header.
